                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2,
                        ...
                        btn_newChallenge.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                addChallengeScreen.putExtra(EXTRA_TAG_FRIEND_ID, friend.friendId);
                                addChallengeScreen.putExtra(EXTRA_TAG_FRIEND_NAME, friend.friendName);
                                addChallengeScreen.putExtra(EXTRA_TAG_FRIEND_DP, friend.friendDp);
                        ...
                        btn_defriend.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                params[1]=new BasicNameValuePair(PHP_TAG_FRIEND_USER_ID, Integer.toString(friend.friendId));
